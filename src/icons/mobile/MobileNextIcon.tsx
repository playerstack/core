...
const MobileNextIcon: React.FC<IconProps> = ({ width = '100%', height = '100%' }) => (
...
MobileNextIcon.displayName = 'MobileNextIcon';

export default React.memo(MobileNextIcon, (p, n) => p.width === n.width && p.height === n.height);
